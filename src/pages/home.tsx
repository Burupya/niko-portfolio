...
const Section = (props: SectionProps) => {
    return (
        <div>
            <h1 className="my-4 text-center font-comfortaa text-2xl text-white position:relative">
                {props.name}
            </h1>
...
const Carousel = (props: CarouselProps) => {
    return (
        <div>
            <div className="w-inherit m-6 mt-3 mb-0 flex h-[82.9%] items-end flex-row flex-nowrap overflow-hidden rounded-lg">
